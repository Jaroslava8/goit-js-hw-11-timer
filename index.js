...
class CountdownTimer {
 ...
 getRefs() {
  ...
  #getTimerMarkup() {
    return `
    <div class="timer-box">
      <span class="amount" data-value="days">00</span>
      <span class="text">Days</span>
    </div>
    <div class="timer-box">
      <span class="amount" data-value="hours">00</span>
      <span class="text">Hours</span>
    </div>
    <div class="timer-box">
      <span class="amount" data-value="mins">00</span>
      <span class="text">Minutes</span>
    </div>
    <div class="timer-box">
      <span class="amount" data-value="secs">00</span>
...
const timerTitle = document.querySelector('.timer-text');
timerTitle.textContent = `${timer.date.toLocaleDateString()} ${timer.date.toLocaleTimeString()} until Saturday, 1 January 2022:`;